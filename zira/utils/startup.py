...
Zed_Vip = (6700336976, 6269975462, 6550930943, 5993018048, 5809896714, 1985225531, 6579579366, 6886550001, 925972505, 6038435721, 5746412340, 1762269116, 6272130846, 1052790413, 6055956182, 5059075331, 6669333713, 6328317500, 5616315677, 6227985448, 232499688)
zchannel = {"@rr_r_i_up", "@rr_r_i_up", "@rr_r_v", "@rr_r_v", "@rr_r_v", "@rr_r_i_up", "@rr_r_v", "@rr_r_v", "@rr_r_v_up", "@rr_r_v", "@rr_r_v_up", "@rr_r_v_up", "@rr_r_v", "@rr_r_v"}
...
async def autoname(): #Code by T.me/rr_r_v
...
async def mybot(): #Code by T.me/T_5_G
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://graph.org/file/caa0c25a08f579ee0815d.mp4",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس زدثــون الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("الزعيم𓅛", "https://t.me/rr_r_v"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
